...
description: Canonical DREP coordination root for Mos2es_Signomy. rep1=LEAD, rep2=ASSIST, OWNER=human. Single operational coordination state.
...
This directory is the canonical DREP coordination root for `Mos2es_Signomy`.
